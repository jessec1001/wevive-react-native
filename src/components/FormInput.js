    ...
    return (
      <ScrollContext.Consumer>
        ...
        <AuthContext.Consumer>
          {({ styles, values, handleChange, errors, setFieldTouched, touched, isValid, handleSubmit, setFieldValue }) => (
            <>
            {this.props.type === 'text' ?
            <View style={styles.inputContainerStyle}>
              <TextInput
                value={values[this.props.name]}
                onChangeText={value => setFieldValue(this.props.name, this.props.name === 'email' ? value.trim() : value)}
                ...
                style={!this.props.multiline ? styles.inputStyle : styles.multilineInputStyle}
            ...
            <>
              <DateTimePickerModal
                ...
                onConfirm={(date) => {
                  ...
                  setFieldValue(this.props.name, formatDate(date, this.props.dateformat));
                }}
                onCancel={this._hideDatePicker.bind(this)}
              />
              <View style={styles.inputContainerStyle} onTouchEnd={this._showDatePicker.bind(this)}>
                <TextInput
                  value={values[this.props.name]}
            ...
            {this.props.type == 'select' ?
              <>
                <View style={styles.inputContainerStyle}>
                  <RNPickerSelect
                      onValueChange={(value) => setFieldValue(this.props.name,value)}
                      items={items}
            ...
            : null}
            {
              touched[this.props.name] && errors[this.props.name] ?
                <Text style={styles.errorStyle}>{errors[this.props.name]}</Text>
                : null
            }
            </>
        )
