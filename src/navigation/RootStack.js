...
import { UserContext as AppUserContext, AppThemeContext } from '../context/UserContext';
                ...
                <AppThemeContext.Provider value={{ themeSettings, goBack, insets }}>
                    <NavigationContainer
                        ...
                        onStateChange={() => {
                            ...
                            onStateChange(currentRoute, navigationRef.current.canGoBack() ? () => { navigationRef.current.goBack();} : null);
                        }}
                    >
                        <MainStack.Navigator
